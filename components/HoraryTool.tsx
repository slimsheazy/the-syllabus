      ...
      <div className="w-full flex flex-col lg:flex-row gap-12 lg:gap-16 items-start">
        <div className="flex-1 w-full space-y-12">
           <header className="space-y-4">
             <h2 className="heading-marker text-7xl text-marker-blue lowercase">Horary Moment</h2>
           ...
           <div className="space-y-8">
             ...
             <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end border-t-4 border-marker-black/10 pt-6 gap-4">
                <div className="space-y-1">
                  ...
                  <span className="handwritten text-3xl font-black text-marker-black">{location ? `${location.lat.toFixed(3)}N / ${location.lng.toFixed(3)}E` : 'Locating...'}</span>
                </div>
           ...
           {loading ? (
             ...
             <div className="w-full space-y-12 pb-24 animate-in fade-in duration-500">
                <div className="flex flex-col items-center gap-6">
                   <span className="handwritten text-2xl text-marker-black font-black italic uppercase tracking-widest">Projection Matrix</span>
                          ...
                          <div key={idx} className="flex flex-col gap-2 border-b-2 border-marker-black/5 pb-4 last:border-0">
                            <div className="flex justify-between items-center">
                              <span className="handwritten text-2xl font-black text-marker-black">
                                {asp.p1} <span className="text-marker-blue italic uppercase">{asp.type}</span> {asp.p2}
                              </span>
                              <span className="handwritten text-2xl text-marker-red font-black">orb: {asp.orb.toFixed(2)}°</span>
                            </div>
