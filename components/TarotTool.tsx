           ...
           {reading && (
             <div className="w-full space-y-10 animate-in fade-in duration-500 pb-16">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                  {drawnCards.map((c, i) => (
                    <div key={i} className={`p-4 marker-border border-marker-black bg-white/40 flex flex-col items-center justify-center text-center aspect-[2/3] sm:aspect-[2/3.5] ${c.isReversed ? 'rotate-180' : ''} transition-all`}>
